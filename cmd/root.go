...
func init() {
	...
	RootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.planrockr-cli.yaml)")
...
func initConfig() {
	...
	viper.SetConfigName(".planrockr-cli") // name of config file (without extension)
